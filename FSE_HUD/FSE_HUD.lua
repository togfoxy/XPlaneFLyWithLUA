...
local intActionTypeLogin = ALARM_NONE
local intActionTypeRegisterFlight = ALARM_NONE
local intActionTypeEndflight = ALARM_NONE
...
local fltTimerForEndFlight = 15		--seconds. How long the plane needs to be landed before it tries to auto-end flight
...
function tfFSE_DrawAutoConnect()
	...
	if intActionTypeLogin == ALARM_NONE then
...
function tfFSE_DrawAutoStart()
	...
	if intActionTypeRegisterFlight == ALARM_NONE then
		graphics.draw_string((x1 + intButtonWidth * 0.15), (y1 + intButtonHeight * 0.6), "No", "white")
		graphics.draw_string((x1 + intButtonWidth * 0.15), (y1 + intButtonHeight * 0.2), "action", "white")
...
function tfFSE_DrawAutoEnd()
	...
	if intActionTypeEndflight == ALARM_NONE then
		graphics.draw_string((x1 + intButtonWidth * 0.15), (y1 + intButtonHeight * 0.6), "No", "white")
		graphics.draw_string((x1 + intButtonWidth * 0.15), (y1 + intButtonHeight * 0.2), "action", "white")
...
function tfFSE_DrawCancelFlight()
	...
	if fse_flying == 1 then
		if bolCancelledArmed == 1 then
			graphics.draw_string((x1 + intButtonWidth * 0.15), (y1 + intButtonHeight * 0.6), "Really", "white")
			graphics.draw_string((x1 + intButtonWidth * 0.15), (y1 + intButtonHeight * 0.2), "Cancel?", "white")
			graphics.set_color( 1, 1, 0, 0.20) --yellow
		else
			graphics.draw_string((x1 + intButtonWidth * 0.15), (y1 + intButtonHeight * 0.4), "Cancel", "white")
			graphics.set_color( 0, 1, 0, 0.20) --green
		end
	else
		graphics.set_color( 1, 1, 1, 0.20) --white
...
function tfFSE_DoAutomation()
	...
	if datGSpd > 10 and fse_connected == 0 and bolLoginAlertRaised == 0 then
		if intActionTypeLogin == ACTION_NONE then
			--do nothing
		elseif intActionTypeLogin == ACTION_TEXTONLY then
